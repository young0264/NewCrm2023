...
class BillController extends BaseController {
     ...
     */
       public function billUpdate(Request $request){
           $log_params = $this->logService->makeBillLogParams($request->input('f_billId'),"T_Bill_NEY","U");
    ...
    public function billRegisterProcess(Request $request){
        ...
        try {
            $log_params = $this->logService->makeBillLogParams($request->input('f_billId'),"T_Bill_NEY","C");
