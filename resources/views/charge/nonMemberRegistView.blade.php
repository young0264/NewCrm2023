                                                                ...
                                                                <div class="card-body">
                                                                    <div class="col-md-12">
                                                                        <div class=" btn-group col-md-3">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <input class="form-control" type="text" placeholder="73212315A" id="html5-text-input"/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="btn-group col-md-3">
                                                                            <label class="col-md-2 col-form-label mb-3" style="color: black">브랜드</label>
                                                                            <div class="col-md-8">
                                                                                <input class="form-control" type="text" placeholder="더벤티" id="html5-text-input"/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="btn-group col-md-3">
                                                                            <label class="col-md-2 col-form-label mb-3" style="color: black">지점명</label>
                                                                            <div class="col-md-8">
                                                                                <input class="form-control" type="text" placeholder="가산테라타" id="html5-text-input"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
